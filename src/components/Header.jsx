...
import { authStateListener, informacionUserAuth } from './AuthMethods';
    ...
    <div id='header'>
      <div className='en1'>
        ...
        <div className='usuario'>
          ...
          {/* <img src={userInfo.photoURL} alt='Photo' /> */}
      ...
      <div id='WBc'><a id='WBac'><button type='button' id='WBec' onClick={informacionUserAuth}>WB2</button></a></div>
