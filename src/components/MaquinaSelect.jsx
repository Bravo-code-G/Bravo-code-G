...
import './MaquinaSelect.js';

let NameMa = 'Sxc'
let FuncionMa = 'Cortadora'
let Estado = 'Detenida'
    ...
    <div id='Box'>
        ...
        <section id='BoxPb'>
            <div className='BoxPba'>
                <button className='BotonAccion' onClick={ventanaA} ><h3 className='TituloSubMenu'>Informacion tecnica de {NameMa}</h3></button>
                <ul id='BoxPbaA' className='Listado' >
                    <li>V: {}</li>
                    <li>Hz: {}</li>
                    <li>A: {}</li>
                    <li>Presion hidraulica: {}</li>
                    <li>Presion Neumatica: {}</li>
                </ul>
            </div>
            <div>
